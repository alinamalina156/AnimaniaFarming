...
public class ItemStackHandlerAF extends ItemStackHandler {
    ...
    public ItemStackHandlerAF(NonNullList<ItemStack> stacks, IAcceptor acceptor, IRemover remover) {
        super(stacks);
        this.acceptor = acceptor;
        this.remover = remover;
    }

    public ItemStackHandlerAF(int slots, IAcceptor acceptor, IRemover remover) {
        super(slots);
        this.acceptor = acceptor;
        this.remover = remover;
    }

    public ItemStackHandlerAF(NonNullList<ItemStack> stacks) {
        this(stacks, ACCEPT_TRUE, REMOVE_TRUE);
    }

    public ItemStackHandlerAF(int slots) {

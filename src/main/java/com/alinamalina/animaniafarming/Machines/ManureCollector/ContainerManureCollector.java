...
public class ContainerManureCollector extends Container
{
	private final TileEntityManureCollector tileentity;
	private int tank, cookTime;
	
	public ContainerManureCollector(InventoryPlayer player, TileEntityManureCollector tileentity) 
	{
	...
	public void detectAndSendChanges() 
	{
		...
		for(int i = 0; i < this.listeners.size(); ++i) 
		{
			...
			if(this.tank != this.tileentity.getField(1)) listener.sendWindowProperty(this, 1, this.tileentity.getField(1));
			if(this.cookTime != this.tileentity.getField(3)) listener.sendWindowProperty(this, 3, this.tileentity.getField(3));
		}

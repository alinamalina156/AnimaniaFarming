...
{	
	...
	{
		addSinteringRecipe(new ItemStack(Items.IRON_INGOT), new ItemStack(ModItems.CRUDE_CARBIDE), new ItemStack(ModItems.IRON_CARBIDE_INGOT), 5.0F);
		addSinteringRecipe(new ItemStack(ModItems.IRON_CARBIDE_INGOT), new ItemStack(Items.QUARTZ), new ItemStack(ModItems.SILICON_STEEL_INGOT), 5.0F);
	}
